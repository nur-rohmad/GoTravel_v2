(function () {
    ...
    ldLoader = function (opt) {
        ...
        ["root", "container"].map(function (n) {
            if (opt[n]) {
                return (this$[n] = (
                    Array.isArray(opt[n]) ? opt[n] : [opt[n]]
                ).map(function (it) {
                    var ret;
                    ret =
                        typeof it === "string"
                    ...
                    if (!ret) {
                        console.warn(
                            "[ldLoader] warning: no node found for " + it
                        );
                    }
                    return ret;
                }));
            ...
            _ = function (t) {
                ...
                if (this$.render.runid === runid) {
                    ...
                    return this$.root.map(function (it) {
                        return this$.opt.ctrl.done.call(
                            it,
                            t - this$.render.start
                        );
                    });
            ...
            return new Promise(function (res, rej) {
                ...
                this$.root.map(function (it) {
                    ...
                    if (this$.opt.inactiveClass) {
                        return it.classList.toggle(
                            this$.opt.inactiveClass,
                            d < 0
                        );
                    }
                });
                ...
                if (running) {
                    this$.z = z =
                        ((ref$ = ldLoader.zstack)[ref$.length - 1] || 0) +
                        this$.opt.baseZ;
                    this$.root.map(function (it) {
